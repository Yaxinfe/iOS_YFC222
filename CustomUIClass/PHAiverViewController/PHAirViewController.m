...
- (void)handleRevealGestureStateChangedWithRecognizer:(UIPanGestureRecognizer *)recognizer
{
    ...
    distanceScroll = fabs(self.view.height/2 - distanceScroll);
...
- (void)reloadData
{
    ...
    for (int i = 0; i < session; i ++) {
        ...
        NSArray *iconArray = [NSArray arrayWithObjects:@"discoveryMenu.png",@"friendMenu.png",@"myeventMenu.png",@"livefeedMenu.png",@"uploadMenu.png",@"settingsMenu.png",@"signoutMenu.png", nil];
        ...
        for (int j = 0; j < [rowsOfSession[i] intValue]; j ++) {
            ...
            [button setImage:[UIImage imageNamed:[iconArray objectAtIndex:j]] forState:UIControlStateNormal];
            ...
            UIImage *image = [[UIImage imageNamed:[iconArray objectAtIndex:j]] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
            [button setImage:image forState:UIControlStateHighlighted];
            [button setImage:image forState:UIControlStateSelected];
            button.tintColor = _titleHighlightColor;
