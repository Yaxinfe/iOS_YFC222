...
- (void) initShow {
    ...
    if (currentPhotoNum == pages.count - 1) {
        [[NSNotificationCenter defaultCenter] postNotificationName:@"pageBtnDelegate" object:nil];
    }
    else{
        [[NSNotificationCenter defaultCenter] postNotificationName:@"pageBtnHiddenDelegate" object:nil];
    }
