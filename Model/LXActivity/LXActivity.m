...
#define CANCEL_BUTTON_COLOR                     [UIColor colorWithRed:35.0/255.0 green:85.0/255.0 blue:140.0/255.0 alpha:1.0]

#define SHAREBUTTON_WIDTH                       60
#define SHAREBUTTON_HEIGHT                      60
#define SHAREBUTTON_INTERVAL_WIDTH              ([UIScreen mainScreen].bounds.size.width - 240)/5
#define SHAREBUTTON_INTERVAL_HEIGHT             35

#define SHARETITLE_WIDTH                        60
#define SHARETITLE_HEIGHT                       20
#define SHARETITLE_INTERVAL_WIDTH               ([UIScreen mainScreen].bounds.size.width - 240)/5
#define SHARETITLE_INTERVAL_HEIGHT              SHAREBUTTON_WIDTH+SHAREBUTTON_INTERVAL_HEIGHT
#define SHARETITLE_FONT                         [UIFont fontWithName:@"Helvetica-Bold" size:15]
...
#define BUTTON_INTERVAL_HEIGHT                  25
...
#define BUTTON_BORDER_COLOR                     [UIColor whiteColor].CGColor
...
{
    UIButton *cancelButton = [[UIButton alloc] initWithFrame:CGRectMake([UIScreen mainScreen].bounds.size.width/2 - 135, BUTTON_INTERVAL_HEIGHT, BUTTON_WIDTH, BUTTON_HEIGHT)];
