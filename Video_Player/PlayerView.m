...
@interface PlayerView () <AVAssetResourceLoaderDelegate, NSURLConnectionDataDelegate>
...
- (void)toggleFullscreen:(UIButton *)button {
  if (fullscreen) {
    ...
    [UIView animateWithDuration:0.2f animations:^{
      ...
      [[NSNotificationCenter defaultCenter] postNotificationName:@"fanHideNaviDelegate" object:nil];
