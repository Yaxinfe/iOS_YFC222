...
#define APP_ID          @"wx19f4270fcbb09a4a"               //APPID
#define APP_SECRET      @"0a94ef83120868cc39da33ff534b1817" //appsecret
//商户号，填写商户对应参数
#define MCH_ID          @"1265326101"
//商户API密钥，填写相应参数
#define PARTNER_ID      @"Fiddptjddl12dlfdp8Wjrjfdmadmr992"
//支付结果回调页面
