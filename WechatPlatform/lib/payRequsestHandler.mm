...
- ( NSMutableDictionary *)sendPay_demo
{
    ...
    NSString *buyBallNum = [[NSUserDefaults standardUserDefaults] objectForKey:@"buyBallNumber"];
    
    //订单标题，展示给用户
    NSString *order_name    = @"Ball_Number";
    //订单金额,单位（分）
    NSString *order_price   = [NSString stringWithFormat:@"%d", [buyBallNum intValue]*100];//1分钱测试
    ...
    [packageParams setObject: @"172.16.3.1"     forKey:@"spbill_create_ip"];//发器支付的机器ip
